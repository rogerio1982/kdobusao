<?php
$locations=array();
$uname="plat4478_admin";
$pass="admin2020";
$servername="localhost";
$dbname="plat4478_kdobusao";
...
?>
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyC9kegdpUpmGy6QR93LZOo_Vr958v7zFIk"></script>
<script type="text/javascript">
    ...
    function initialize() {
        var mapOptions = {
            zoom: 6,
            center: new google.maps.LatLng(-0.85104,-48.13866),
        };
